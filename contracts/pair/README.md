# PalomaDex Constant Product Pair
...
PalomaDex has two options to protect traders against slippage during swaps:
...
Please note that PalomaDex has the default value for the spread set to 0.5% and the max allowed spread set to 50%.
